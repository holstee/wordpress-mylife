<?php get_header(); ?>
  ...
  <div class="container-fluid" id="mylife-primary">
    <div class="background">
      <img src="<?php bloginfo('template_directory');?>/assets/images/background.jpg">
      <div class="overlay"></div>
    </div>
    <div class="foreground">
      <div class="container">
        <div class="span12">
          <p class="tk-brandon-grotesque hyper">WELCOME TO MYLIFE</p>
          ...
          <a class="btn btn-inverse">Share your story &amp; passion</a>
        </div>
      </div>
    </div>
  </div>

  <div class="container-fluid hide" id="mylife-secondary-dummy" style="height:175px">
    <div class="container">
      <div class="row">
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="span12 tk-ff-tisa-web-pro jumbo" id="swap">
          ...
          <a href="/about" id="swap-link"><span id="swap-name">Lee Ann</span> - <span id="swap-location">Texas<span></a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container-fluid tk-brandon-grotesque" id="mylife-tertiary">
    <div class="container">
      <div class="row">
          <a href="/share-your-story" class="span3">Share your story</a>
          <a href="#share" class="span3">Share with friends</a>
          <a href="/search-mylife" class="span3">Search Mylife</a>
          <a href="/most-shared" class="span3">Most Shared</a>
      </div>
    </div>
  </div>
